    ...
    <v-container>
      <div class="row">
        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            <p class="display-1 mb-0">Ultimate Cat Carrier</p>
                ...
                >
                  ...
                  >
                    <v-img
                      ...
                      :src="require('../assets/img/home/deal1.jpg')"
                    >
                      <v-card-title>Bags & Carriers </v-card-title>
                    </v-img>
              ...
              <div class="col-md-2 col-sm-4 col-xs-12 text-center" >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <v-card-title>Toys </v-card-title>
                    </v-img>

                    <v-card-text class="text--primary text-center">
                      <div>Upto 50%</div>
                      <div>Dogs, Cats, Tigers</div>
                    </v-card-text>
              ...
              <div class="col-md-2 col-sm-4 col-xs-12 text-center" >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <v-card-title>Festive Costumes </v-card-title>
                    </v-img>

                    <v-card-text class="text--primary text-center">
                      <div>Upto 60% + Extra 10%</div>
                      <div>Halloween, Thanksgiving, Christmas</div>
                    </v-card-text>
