...
namespace PetApi.Helpers
{
    public class GatherInfo
    {
        ...
        private const string CONNSTR = "server=localhost;user=root;database=petsupplyplus;port=3306;password=KMX10!@m;"; //Need to update password to whatever we are using 
