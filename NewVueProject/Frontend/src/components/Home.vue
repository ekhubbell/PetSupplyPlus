      ...
      >
        <v-card outlined>
          <v-img
            ...
            height="300px"
          >
            <h1 class="text-center font-size">Toys</h1>
      ...
      >
        <v-card outlined>
          <v-img
            ...
            height="300px"
          >
            <h1 class="text-center font-size">Pet Healthy</h1>
            <div class="text-center mt-2">
              <v-btn class="white--text caption"  href="/shop" text>SHOP NOW <v-icon class="white--text caption">mdi-arrow-right</v-icon></v-btn>
            </div>
          </v-img>
      ...
      >
        <v-card outlined>
          <v-img
            ...
            height="300px"
          >
            <h1 class="text-center font-size">Accessories</h1>
            <div class="text-center mt-2">
              <v-btn class="white--text caption"  href="/shop" text>SHOP NOW <v-icon class="white--text caption">mdi-arrow-right</v-icon></v-btn>
            </div>
          </v-img>
            ...
            <div class="row">
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center">
                ...
                >
                  ...
                  >
                    <v-card-title>Cat Accessories </v-card-title>
                  </v-img>

                  <v-card-text class="text--primary text-center">
                    <div>Upto 60% + Extra 10%</div>
                    <div>Belts, Clothes, Carriers</div>
                  </v-card-text>
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    ...
                    :src="require('../assets/img/home/deal2.jpg')"
                  >
                    <v-card-title>Dog Toys</v-card-title>
                  </v-img>

                  <v-card-text class="text--primary text-center">
                    <div>Upto 50%</div>
                    <div>Balls, Ropes, Tires</div>
                  </v-card-text>
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    ...
                    :src="require('../assets/img/home/deal3.jpg')"
                  >
                    <v-card-title>Halloween Customes </v-card-title>
                  </v-img>
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    ...
                    :src="require('../assets/img/home/deal4.jpg')"
                  >
                    <v-card-title>Bedding </v-card-title>
                  </v-img>
